# Termos-de-uso-Seraphine Corporation
...
Presence and member data collection from Seraphine:
...
Server member list data collection from Seraphine:
...
Event data collection from Seraphine:
...
Anyways thank you for using Seraphine.
