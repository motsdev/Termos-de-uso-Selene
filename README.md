# Termos-de-uso-Emylee Corporation
...
Presence and member data collection from Emylee:
...
Server member list data collection from Emylee:
...
Event data collection from Emylee:
...
Anyways thank you for using Emylee.
